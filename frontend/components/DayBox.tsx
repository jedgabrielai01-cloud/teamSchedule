...
export default function DayBox({ date, currentMonth, leaves, schedule, holidays, onEdit }: Props) {
  ...
  return (
    <div
      data-testid="day-box"
      className="min-h-32 p-1.5 flex flex-col border group relative"
      style={{
